...
│   └── generate-store-assets.py ← Pillow: renders assets/*.png store images (standalone, not in CI)
├── .github/
│   └── workflows/
...
├── assets/                     ← Store screenshots + promo tile — COMMITTED, generated by scripts/generate-store-assets.py
